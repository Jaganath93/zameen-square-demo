      ...
      <div className="row gy-4 gy-lg-0 justify-content-xl-between">
        <div className="col-12 col-md-6 col-lg-6 col-xl-4">
          <div className="widget">
            <a href="#!">
              <img src="https://zameensquare.com/_next/static/media/zameen-logo.be926326.png" alt="BootstrapBrain Logo" width="175" height="40"/>
            </a>
          </div>
          <div className="col-12 col-md-12 col-lg-6 col-xl-12 mt-3">
          <div className="widget">
            <p className="mb-4">Reach our team at <span className="fw-bold">+91 6363099125</span> or mail us to <span className="fw-bold">contact@zameensquare.com</span> for all enquires.</p>
            <h4 className="widget-title mb-2 text-primary">Subscribe Us</h4>
            <form action="#!">
              <div className="row gy-4">
                <div className="col-12">
                  <div className="input-group">
                    ...
                    <input type="email" className="form-control" id="email-newsletter" value={email} placeholder="Enter your email address" aria-label="email-newsletter" aria-describedby="email-newsletter-addon" onChange={(e)=> setEmail(e.target.value)} required/>
                    <button className="btn btn-success footer-btn border-0" type="submit" onClick={handleSubscribe}>Subscribe</button>
                  </div>
                </div>
                {/* <div className="col-12">
        ...
        <div className="col-12 col-md-3 col-lg-3 col-xl-2">
          <div className="widget">
            <h4 className="widget-title mb-4 text-primary">Quick Links</h4>
            <ul className="list-unstyled">
              ...
              <li className="mb-2">
                <a href="#!" className="link-secondary text-decoration-none">Refund Policy</a>
              </li>
              <li className="mb-0">
                <a href="#!" className="link-secondary text-decoration-none">Terms & Conditions</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="col-12 col-md-3 col-lg-3 col-xl-4">
          <div className="widget">
            <h4 className="widget-title mb-4 text-primary">Top Localities</h4>
            <ul className="list-unstyled">
              <li className="mb-2">
                <a href="#!" className="link-secondary text-decoration-none">Properties in New Delhi</a>
              </li>
              <li className="mb-2">
                <a href="#!" className="link-secondary text-decoration-none">Properties in Bengaluru</a>
              </li>
              <li className="mb-2">
                <a href="#!" className="link-secondary text-decoration-none">Properties in Hyderabad</a>
              </li>
              <li className="mb-2">
                <a href="#!" className="link-secondary text-decoration-none">Properties in Mumbai</a>
              </li>
              <li className="mb-0">
                <a href="#!" className="link-secondary text-decoration-none">Properties in Chennai</a>
              </li>
            </ul>
          </div>
        </div>
