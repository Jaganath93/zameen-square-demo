...
<span>{data.rating} Ratings {(data.peopleRated)}</span> 
    ...
    <button className="btn btn-primary w-100 me-3">Contact</button>
    <button className="share-btn rounded"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-share-fill" viewBox="0 0 16 16">
